        ...
        <div className={styles.page}>
            ...
            <Card title="🌴 Đơn nghỉ phép">
                ...
                <div className={styles.toolbar}>
                    ...
                    <select className={styles.select} value={departmentId}
                            onChange={(e) => setDepartmentId(e.target.value)} aria-label="Phòng ban">
                    ...
                    <div className={styles.dateFilters}>
                        <input className={styles.dateInput} type="date" value={fromDate}
                               onChange={(e) => setFromDate(e.target.value)} aria-label="Từ ngày"/>
                        <span className={styles.dateSep}>→</span>
                        <input className={styles.dateInput} type="date" value={toDate}
                               onChange={(e) => setToDate(e.target.value)} aria-label="Đến ngày"/>
                    </div>
                ...
                <div className={styles.pagination}>
                    <div
                        className={styles.pageHint}>{total === 0 ? "0 kết quả" : `Trang ${pageSafe}/${totalPages} • ${total} đơn`}</div>
