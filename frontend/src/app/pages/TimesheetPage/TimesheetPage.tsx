...
import {exportExcelHtml, exportTimelogExcel} from "../../../shared/lib/excelExport";
import {
    CheckCircleOutlined,
    ClockCircleOutlined,
    DeleteOutlined,
        ...
        <div className={styles.page}>
            ...
            >
                <div className={styles.filters}>
                    <div className={styles.filterItem}>
                        ...
                        <input className={styles.input} type="date" value={fromDate}
                               onChange={(e) => setFromDate(e.target.value)}/>
                    </div>
                    <div className={styles.filterItem}>
                        <div className={styles.filterLabel}>Đến ngày</div>
                        <input className={styles.input} type="date" value={toDate}
                    ...
                    <label className={styles.check}>
                        <input type="checkbox" checked={includeAbsent}
                               onChange={(e) => setIncludeAbsent(e.target.checked)}/> Hiện vắng
                    </label>
                    <button className={`${styles.btn} ${styles.btnPrimary}`} type="button" disabled={busy}
            ...
            >
                ...
                <div className={styles.pagination}>
                    <div
                        className={styles.pageHint}>{hasMore ? `Đang hiển thị ${rows.length} bản ghi gần nhất theo bộ lọc` : `Đã hiển thị ${rows.length} bản ghi theo bộ lọc`}</div>
                    {hasMore ? (
                        <button className={`${styles.btn} ${styles.btnGhost}`} type="button" disabled={busy}
                                onClick={() => void refresh(offset + pageSize, true)}>
            ...
            >
                <div className={styles.formGrid}>
                    <div className={styles.formItem}>
                        ...
                        <input className={styles.input} type="time" value={editCheckin}
                               onChange={(e) => setEditCheckin(e.target.value)}/>
                    </div>
                    <div className={styles.formItem}>
                        <div className={styles.filterLabel}>Giờ ra</div>
                        <input className={styles.input} type="time" value={editCheckout}
                               onChange={(e) => setEditCheckout(e.target.value)}/>
                    </div>
                </div>
                <div className={styles.note} style={{marginTop: 10}}>
                    Lưu ý: thao tác này sẽ ghi đè log check-in/check-out trong ngày (nếu có) và đánh dấu phương thức là
                    Manual.
                </div>
            </Modal>
        </div>
